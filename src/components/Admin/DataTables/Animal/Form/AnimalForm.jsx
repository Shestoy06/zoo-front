...
const AnimalForm = ({state, handleChange, handleSubmit, setImageFile, imageField}) => {
    ...
    return (
        <form onSubmit={handleSubmitAndPreventDefault} >
            ...
            <Button type={'submit'} disabled={state.animalHabitat === ''} style={{paddingTop: 10, marginLeft: -13}}>Save</Button>
        </form>
