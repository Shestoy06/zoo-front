...
export const AnimalTableHead = () => {
    ...
    return (
        <TableRow>
            {InfoHeadColumns.map(column => <TableCell style={alignRight}>{column}</TableCell>)}
        </TableRow>
    )
}
...
export const AnimalExtendedTableHead = () => {
    ...
    return (
        <TableRow>
            {AdditionalInfoHeadColumns.map(column => <TableCell style={alignRight}>{column}</TableCell>)}
        </TableRow>
    )
}
